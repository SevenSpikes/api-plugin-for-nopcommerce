...
namespace Nop.Plugin.Api.Controllers
{
    public class SpecificationAttributesController : BaseApiController
    {
        ...
        [ProducesResponseType(typeof(ErrorsRootObject), (int) HttpStatusCode.BadRequest)]
        [GetRequestsErrorInterceptorActionFilter]
        public IActionResult GetSpecificationAttributesCount(SpecificationAttributesCountParametersModel parameters)
        {
        ...
        public IActionResult DeleteSpecificationAttribute(int id)
        {
            ...
            //activity log
            CustomerActivityService.InsertActivity("DeleteSpecAttribute", LocalizationService.GetResource("ActivityLog.DeleteSpecAttribute"),
                                                   specificationAttribute);
