...
{
    //public class ProductPictureAttribute : AbstractValidator<ProductPictureDto>
    //{
    //    private Dictionary<string, string> _errors;
    //    private readonly IPictureService _pictureService;

    //    public ProductPictureAttribute()
    //    {
    //        _errors = new Dictionary<string, string>();
    //        _pictureService = EngineContext.Current.Resolve<IPictureService>();
    //    }

    //    public override void Validate(ProductPictureDto instance)
    //    {
