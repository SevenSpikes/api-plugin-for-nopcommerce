...
namespace Nop.Plugin.Api.Data
{
    public class ApiObjectContext : DbContext, IDbContext
    {
        ...
        public ApiObjectContext(DbContextOptions<ApiObjectContext> options) : base(options)
        {
        }
        ...
        {
            var nopDataAssembly = Assembly.GetAssembly(typeof(NopObjectContext));

            //dynamically load all entity and query type configurations
            var typeConfigurations = nopDataAssembly.GetTypes().Where(type => 
        ...
        protected virtual string CreateSqlWithParameters(string sql, params object[] parameters)
        {
            ...
            {
                if (parameters == null || !(parameters[i] is DbParameter parameter))
                {
                    continue;
                }
